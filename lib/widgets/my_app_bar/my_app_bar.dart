...
/// the screen see [MyAppBar], which is used in the [Scaffold.appBar] slot.
///
...
class MySliverAppBar extends StatefulWidget {
  ...
  ///
  /// This property is used to configure an [MyAppBar].
  final Widget? leading;
  ...
  /// content is not scrolled under the [MyAppBar].
  ///
  /// Defaults to false, meaning that the [elevation] is only applied when the
  /// [MyAppBar] is being displayed over content that is scrolled under it.
  ///
